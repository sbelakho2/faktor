...
ALLOWLIST_FRAGMENTS=(
  ...
  '/vendor/'
  '/third-party/'
  # The PINNED, hash-verified upstream webview bundle staged into the
  # extension at package time (verbatim upstream bytes; regenerated by
  # prepackage:vsix and verified against ui/upstream.json hashes). The
